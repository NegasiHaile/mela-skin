/*
  Duplicated from ../../components/brand/Marks.tsx on purpose — each direction
  folder stands alone so the losing one can be deleted whole. Keep the two in
  step when the artwork changes.
*/
/**
